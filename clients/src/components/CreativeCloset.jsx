...
const CreativeCloset = () => {
  // Define button data containing image source and initial button text
  const buttonsData = [
    { image: framePainting, initialText: "Place" },
    { image: yarn, initialText: "Place" },
    { image: easelPainting, initialText: "Place" },
    { image: paintBrush, initialText: "Place" },
